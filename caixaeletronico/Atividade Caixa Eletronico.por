programa
{
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		inteiro resto_50=0, resto_20=0, total=0

		total=0
		
		resto_50=valor_saque%50
		
		total=(notas_50+notas_20+notas_10)

		resto_20=resto_50%20
		
		notas_50 = valor_saque / 50
		
				se (resto_50!=0 e total!=valor_saque){
					notas_20 = resto_50/20
					
				}
					se (notas_50+notas_20!=valor_saque){
